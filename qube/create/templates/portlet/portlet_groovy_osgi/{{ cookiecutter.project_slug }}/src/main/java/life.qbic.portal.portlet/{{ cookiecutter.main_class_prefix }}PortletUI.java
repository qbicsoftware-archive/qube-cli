...
@Component(
    service = UI.class,
    property = {"com.liferay.portlet.display-category=category.sample",  // Widget category
        "javax.portlet.name={{ cookiecutter.main_class_prefix }}",                    // Unique portlet name in Liferay
        ...
        "xservice.ranking:Integer=1000"},              // Is Vaadin UI?
    scope = ServiceScope.PROTOTYPE)  // New instance created for each distinct request. Mandatory.
public class {{ cookiecutter.main_class_prefix }}PortletUI extends UI{
