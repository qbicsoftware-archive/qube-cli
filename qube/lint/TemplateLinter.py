...
from qube.util.dir_util import pf
...
class TemplateLinter(object):
    ...
    def check_files_exist(self, is_subclass_calling=True):
        ...
        Files that *should not* be present::
            none
        Raises:
            An AssertionError if .qube.yml is not found found.
        """
        ...
        files_warn = [
            ...
            [os.path.join('.github', 'workflow', 'pr_to_master_from_patch_release_only.yml')],
            [os.path.join('.github', 'workflow', 'qube_lint.yml')],
            [os.path.join('.github', 'workflow', 'sync_project.yml')],
        ...
        # First - critical files. Check that this is actually a qube based project
        if not os.path.isfile(pf(self, '.qube.yml')):
    ...
    def print_results(self):
        ...
        def format_result(test_results):
            ...
            for eid, msg in test_results:
                results.append(f"1. [https://qube/linting/errors#{eid}](https://qube/linting/errors#{eid}): {msg}")
