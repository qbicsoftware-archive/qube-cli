...
class TemplateLister:
    """
    A class responsible for listing all available qube templates in a nice layout
    """
    ...
    def list_available_templates(self) -> None:
        ...
        print('[bold blue]Run [green]qube info [blue]for long descriptions of your template of interest')
        print()
        ...
        table = Table(title="[bold]All available qube templates", title_style="blue", header_style=Style(color="blue", bold=True), box=HEAVY_HEAD)
